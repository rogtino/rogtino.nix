    ...
    },
    {
        ...
        config = function()
            ...
            vim.keymap.set(
                ...
                { silent = true, buffer = 0, desc = 'update_crates' }
            )
            vim.keymap.set(
                'n',
                '<leader>ca',
            ...
            vim.keymap.set(
                ...
                { silent = true, buffer = 0, desc = 'upgrade_crate' }
            )
            vim.keymap.set(
                'v',
                '<leader>cU',
                crates.upgrade_crates,
                { silent = true, buffer = 0, desc = 'upgrade_crates' }
            )
            vim.keymap.set(
                'n',
                '<leader>cA',
            ...
            vim.keymap.set(
                ...
                { silent = true, buffer = 0, desc = 'open_homepage' }
            )
            vim.keymap.set(
                'n',
                '<leader>cR',
                crates.open_repository,
                { silent = true, buffer = 0, desc = 'open_repository' }
            )
            vim.keymap.set(
                'n',
                '<leader>cD',
            ...
            vim.keymap.set(
                ...
                { silent = true, buffer = 0, desc = 'open_crates_io' }
            )
            crates.setup {}
        end,
    },
