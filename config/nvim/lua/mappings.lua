...
vim.keymap.set("n", "<leader>y", "ggVGy", { desc = "copy-all-content" })
vim.keymap.set("n", "<leader>pp", "ggVGP", { desc = "paste-all-content" })
...
vim.keymap.set("n", "<leader>st", vim.cmd.TroubleToggle, { desc = "toggle trouble" })
vim.keymap.set("n", "<leader>sd", vim.cmd.TodoLocList, { desc = "search all todo comments" })
vim.keymap.set("n", "<leader>si", function()
	vim.cmd.IconPickerInsert("nerd_font_v3")
end, { desc = "search a icon" })
vim.keymap.set("v", "<", "<gv")
vim.keymap.set("v", ">", ">gv")
